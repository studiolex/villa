    ...
    <>
      <footer className="">
        <div className="grid grid-cols-2  2xl:w-full lg:flex lg:flex-col md:gap-0">
          <div className="bg-darkcream p-12 py-20 2xl:px-12 md:py-10 md:space-y-6 lg:py-20 md:px-6 sm:px-4 xs:px-2">
          ...
          <div className="w-[calc(50rem-3rem)] p-12 mr-auto grid grid-cols-2 gap-6 py-20 2xl:w-full md:flex md:px-6 md:justify-around md:py-10 sm:px-4 xs:px-2">
